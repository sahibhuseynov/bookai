...
import { FaPlayCircle, FaLongArrowAltRight, FaBahai } from "react-icons/fa";
import { Link } from "react-router-dom";
import { useSelector } from "react-redux"; // Redux'tan kullanıcı bilgisini almak için

function HeroSection() {
  const user = useSelector(state => state.user); // Redux store'dan user state'ini alıyoruz
  return (
    <section className="bg-gradient-to-b from-[#f8f9fc] to-[#f8f9fc] py-10 sm:py-20">
      <div className="max-w-6xl mx-auto text-center flex flex-col items-center justify-center">
        ...
        {/* Animasyonlu h1 */}
        <motion.h1
          className="text-3xl sm:text-7xl font-extrabold  "
        ...
        {/* Animasyonlu h1 */}
        <motion.h1
          className="text-5xl sm:text-7xl font-extrabold mb-3 text-blue-800"
