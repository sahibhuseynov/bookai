...
function HeroSection() {
  return (
    <section className="bg-gradient-to-r py-20 max-w-4xl mx-auto text-center flex flex-col items-center justify-center">
      <div className="rounded-full flex gap-3 border border-blue-100 px-3 py-2 items-center justify-center mb-8 shadow-md hover:shadow-lg duration-300 cursor-pointer">
        <FaBahai size={20} />
