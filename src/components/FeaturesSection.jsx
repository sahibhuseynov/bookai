...
function BooksShowcaseSection() {
  return (
    <section className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center py-16 px-8 bg-gray-100">
      {/* Sol Taraf: Metin */}
      <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-10 text-center md:text-left">
        ...
        <p className="text-lg text-gray-600">
          Design a one-of-a-kind children's story with our intuitive AI-powered storybook creator. Tailor every detail with unique characters, vibrant illustrations, and captivating plots. With the added fun of text-to-speech narration, your little one will love every moment of reading. Begin crafting your personalized storybook today.
        </p>
